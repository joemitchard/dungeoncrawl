...
// define a prelude moduile with imported elements
mod prelude {
...
impl State {
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "You put the amulet on and feel it's power course through your veins...");
